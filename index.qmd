...
<a href="sobre.qmd" class="button">Conheça melhor minha trajetória,</a>
  <a href="portifolio.qmd" class="button">meu portfólio</a>
  <a href="servicos.qmd" class="button">e os serviços oferecidos</a>
</div>
...
<script>
  var options = {
    strings: [
      "Me chamo <strong>Lucca Nielsen</strong> e atuo como <strong>analista de dados</strong> especializado em desenvolver soluções para a área da <strong>Saúde Pública</strong>, <strong>vigilância epidemiológica</strong> e diversos outros setores. Se você precisa <strong>entender</strong> melhor os dados da sua organização ou do seu projeto de pesquisa, <strong>automatizar</strong> rotinas e processos, <strong>desenvolver</strong> dashboards e sites interativos ou se quiser simplesmente <strong>aprender</strong> sobre uso da linguaguem de programção <strong>R</strong> aplicada, talvez eu possa te ajudar! Vamos transformar seus dados em insights práticos e eficientes."
    ],
    typeSpeed: 25,
    backSpeed: 0,
    loop: false,
